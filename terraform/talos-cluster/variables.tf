...
variable "nodes" {
  ...
  default = {
    ...
    # TODO: fat worker — resize to vcpu = 8, mem = 28672 in a maintenance window (VM stop/start reboots
    # the node hosting Vault/Harbor/GitLab/ArgoCD). Currently pinned to live size after the MS-A2 recreate.
